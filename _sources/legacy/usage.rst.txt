...
* **Interactive planning**: ``cruiseplan stations`` - Place points on interactive maps with bathymetry
...
**Catalog Section**
  ...
  * ``points``: Geographic locations with operation types (CTD, mooring, etc.)
  * ``lines``: Movement between locations or survey patterns

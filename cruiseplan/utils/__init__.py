...
These utilities provide shared functionality across different parts of the cruiseplan
system, including data processing, configuration management, and coordinate handling.
"""

...
used in oceanographic and maritime contexts.
"""
...
class UnitConverter:
    ...
    def decimal_degrees_to_dmm(decimal_degrees: float) -> Tuple[float, float]:
        ...
        Args:
            decimal_degrees: Coordinate in decimal degrees format
...
def format_dmm_comment(lat: float, lon: float) -> str:
    ...
    Returns
    -------
        str: DMM comment like "65 44.75'N, 024 28.75'W"
...
def format_position_string(lat: float, lon: float, format_type: str = "dmm") -> str:
    ...
    Args:
        lat: Latitude in decimal degrees
        lon: Longitude in decimal degrees
        format_type: Format type - 'dmm' for degrees/decimal minutes,
...
def format_position_latex(lat: float, lon: float) -> str:
    ...
    Returns
    -------
        str: LaTeX-formatted position string
...
def parse_dmm_format(coords_str: str) -> Tuple[float, float]:
    ...
    Args:
        coords_str: Coordinate string in DMM format

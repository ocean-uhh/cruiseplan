...
def main(args=None):
    """
    Entry point for downloading bathymetry data assets.
    ...
    if source is None:
        ...
        if source is not None:
            print("⚠️  WARNING: '--source' is deprecated. Use '--bathy-source' instead.")
    if source is None:
    ...
    print("========================================")
    print("   CRUISEPLAN BATHYMETRY DOWNLOADER")
    print("========================================")
    ...
    try:
        ...
        if citation:
            ...
            print(f"  cruiseplan bathymetry --bathy-source {source} --citation")
        print("=" * 60)

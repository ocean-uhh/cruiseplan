...
def determine_steps(args: argparse.Namespace) -> List[str]:
    ...
    map_formats = []
    format_was_explicitly_set = hasattr(args, 'format') and args.format and args.format != "all"  # Check if user explicitly set format
...
def create_enrich_args(args: argparse.Namespace, input_config: Path, output_config: Path) -> argparse.Namespace:
    """
    ...
    enrich_args.output = output_config.stem.replace('_enriched', '')  # Remove suffix to get base name
...
def create_validate_args(args: argparse.Namespace, config_file: Path) -> argparse.Namespace:
    """
...
def create_map_args(args: argparse.Namespace, config_file: Path, base_name: str) -> argparse.Namespace:
    """

...
class TestGenerateCruiseSchedule:
    ...
    def test_generate_cruise_schedule_basic(self, mock_cruise_class, mock_generate_timeline, tmp_path):
    ...
    @patch("cruiseplan.calculators.scheduler.generate_timeline")
    @patch("cruiseplan.core.cruise.Cruise")
    def test_generate_cruise_schedule_with_validation(self, mock_cruise_class, mock_generate_timeline, mock_validate, tmp_path):
    ...
    @patch("cruiseplan.calculators.scheduler.generate_timeline")
    @patch("cruiseplan.core.cruise.Cruise")
    def test_generate_cruise_schedule_selected_leg(self, mock_cruise_class, mock_generate_timeline, tmp_path):
        ...
        mock_timeline = [
            {"activity": "Station", "leg_name": "Leg1", "duration_minutes": 60.0, "transit_dist_nm": 0, "operation_dist_nm": 0},
            {"activity": "Station", "leg_name": "Leg2", "duration_minutes": 60.0, "transit_dist_nm": 0, "operation_dist_nm": 0},
        ]
        mock_generate_timeline.return_value = mock_timeline
    ...
    @patch("cruiseplan.core.cruise.Cruise")
    def test_generate_cruise_schedule_nonexistent_leg(self, mock_cruise_class, tmp_path):
    ...
    @patch("cruiseplan.core.validation.validate_configuration_file")
    @patch("cruiseplan.core.cruise.Cruise")
    def test_generate_cruise_schedule_validation_error(self, mock_cruise_class, mock_validate, tmp_path):

...
class TestProcessCommand:
    ...
    def test_main_handles_processing_failure(self):
        ...
        with patch("cruiseplan.process") as mock_api, \
             ...
             patch("cruiseplan.cli.process._validate_config_file", return_value=Path("test_config.yaml")), \
             patch("cruiseplan.cli.process._format_progress_header"), \
             patch("cruiseplan.cli.process._resolve_cli_to_api_params", return_value={}), \
             patch("cruiseplan.cli.process._convert_api_response_to_cli", return_value={"success": False, "errors": ["Processing failed", "Missing data"]}), \
    ...
    def test_main_handles_cli_error(self):
        ...
        with patch("cruiseplan.cli.process._setup_cli_logging"), \
             patch("cruiseplan.cli.process._validate_config_file") as mock_validate, \
            ...
            mock_format_error.assert_called_once_with("process", mock_validate.side_effect)

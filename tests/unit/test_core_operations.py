...
from cruiseplan.core.operations import AreaOperation, BaseOperation, LineOperation, PointOperation
...
class TestPointOperation:
    ...
    def test_calculate_duration_station_ctd(self):
        ...
        # So we'll mock the return value
        with pytest.patch('cruiseplan.core.operations.DurationCalculator') as mock_calc_class:
            mock_calc = MagicMock()
...
class TestLineOperation:
    ...
    def test_line_operation_initialization(self):
        ...
        op = LineOperation(
            ...
            route=route,
            speed=12.0,
            comment="Transit to station area"
        )
    ...
    def test_calculate_duration_valid_route(self):
        ...
        with pytest.patch('cruiseplan.core.operations.haversine_distance') as mock_distance:

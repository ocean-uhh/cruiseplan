...
class TestPangaeaCommand:
    ...
    def test_main_calls_api_with_correct_params(self):
        ...
        with patch("cruiseplan.pangaea") as mock_api, \
             ...
             patch("cruiseplan.cli.pangaea._detect_pangaea_mode", return_value=("search", {"query": "CTD temperature"})), \
            ...
            mock_api.return_value = ([{"name": "test"}], [Path("data/atlantic_study_stations.pkl")])
    ...
    def test_doi_file_mode_calls_api_correctly(self):
        ...
        with patch("cruiseplan.pangaea") as mock_api, \
            ...
            # Mock successful API response
            mock_api.return_value = ([{"name": "test"}], [Path("data/dois_stations.pkl")])
    ...
    def test_deprecated_output_file_parameter_still_works(self):
        ...
        with patch("cruiseplan.pangaea") as mock_api, \
            ...
            # Mock successful API response  
            mock_api.return_value = ([{"name": "test"}], [Path("/custom/path/results.pkl")])

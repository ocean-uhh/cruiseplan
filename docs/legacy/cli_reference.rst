...
.. code-block:: bash
    ...
    usage: cruiseplan [-h] [--version] {bathymetry,schedule,stations,enrich,validate,map,process,pangaea} ...
...
.. code-block:: bash
    ...
    $ cruiseplan schedule -c data/expedition_2024_enriched.yaml --output expedition_schedule -o results/
